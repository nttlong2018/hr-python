...
.run(['$templateCache', function ($templateCache) {
    ...
    $templateCache.put('app/components/tree/tree-table/tree-table.html', '<div id="scrolling_table" class="zb-tree-table"><table id="treetable"><thead><tr><th style="background-color:white" class="fixed freeze zb-tree-table-checkbox"><label class="custom-checkbox"><input type="checkbox" ng-model="model"> <span></span></label></th><th style="background-color:white" class="fixed freeze">Col header</th><th style="background-color:white" class="fixed freeze_vertical">Col header</th><th style="background-color:white" class="fixed freeze_vertical">Col header</th><th style="background-color:white" class="fixed freeze_vertical">Col header</th><th style="background-color:white" class="fixed freeze_vertical">Col header</th><th style="background-color:white" class="fixed freeze_vertical">Col header</th><th style="background-color:white" class="fixed freeze_vertical">Col header</th><th style="background-color:white" class="fixed freeze_vertical">Col header</th><th style="background-color:white" class="fixed freeze_vertical">Col header</th><th style="background-color:white" class="fixed freeze_vertical">Col header</th><th style="background-color:white" class="fixed freeze_vertical">Col header</th></tr></thead><tbody><tr><td class="fixed freeze_horizontal zb-tree-table-checkbox"></td><td class="fixed freeze_horizontal"></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr></tbody></table></div>');
}]);
