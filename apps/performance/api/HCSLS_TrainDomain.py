...
def insert(args):
    try:
        ...
        if args['data'] != None:
            ...
            ret  =  models.HCSLS_TrainDomain().insert(data)
            lock.release()
            return ret
...
def set_dict_insert_data(args):
    ...
    ret_dict.update(
        ...
        domain_name      = (lambda x: x['domain_name']     if x.has_key('domain_name')      else None)(args['data']),
        ...
        domain_name2   = (lambda x: x['domain_name2']      if x.has_key('domain_name2')     else None)(args['data'])
    )
