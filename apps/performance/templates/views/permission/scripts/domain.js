(function (scope) {
     ...
     */
    function onEdit() {
        openDialog('Chỉnh sửa vùng truy cập', '../pages/permission/form/editDomain', function () { });
    }
     ...
     */
    function onAdd() {
        openDialog('Thêm mới vùng truy cập', '../pages/permission/form/editDomain', function () { });
    }
